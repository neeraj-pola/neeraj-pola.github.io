...
Here, as constrained we initialize with top left node i.e., y<span style="vertical-align: super; font-size: medium;">b</span><span style="vertical-align: super; font-size: medium;">0</span>~.
