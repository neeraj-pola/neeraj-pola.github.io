...
BP(t=1 ,r=0) = 0 {position of parent node} ,because there is only one parent node (y<span style="vertical-align: super; font-size: medium;">b</span><span style="vertical-align: sub; font-size: medium;">0</span>)

Bscr(t=1,r=0) = Bscr(BP(t=1,r=0)) * y<span style="vertical-align: super; ">b</span><span style="vertical-align: sub; ">1</span> {the current node} --> Bscr(0th node {y<span style="vertical-align: super; ">b</span><span style="vertical-align: sub;">0</span>}) * y<span class = 'super'>b</span><span style="vertical-align: sub;">1</span> --> yb0 * yb1
